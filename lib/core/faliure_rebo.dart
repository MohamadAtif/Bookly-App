...
abstract  class Faliure{
 ...
 class ServerFaliure extends Faliure {
      ...
      factory ServerFaliure.formDioException(DioException dioException) 
    {
      switch (dioException.type) {
        ...
        case DioExceptionType.badResponse:
          return ServerFaliure.fromRespose(dioException.response!.statusCode!, dioException.response!.data);
     ...
     default : return ServerFaliure('oppsss there was an error , Please try Later!');
    ...
    else { return ServerFaliure('oppsss there was an error , Please try Later!');}
